...
- Public Foundry-hosted execution runs the same graph through Responses 2.0.
- The public frontend keeps the same stable API and SSE contract through the
  same-origin wrapper.

The trigger behavior below is the business contract across all surfaces.
