...
grep -Fq "name: 'b7e6dc6d-f1e8-4753-8033-0f276bb0955b'" "$data_roles_module"
...
grep -Fq "conditionVersion: '2.0'" "$data_roles_module"
grep -Fq "StringStartsWithIgnoreCase \\'\${projectWorkspaceId}\\'" "$data_roles_module"
