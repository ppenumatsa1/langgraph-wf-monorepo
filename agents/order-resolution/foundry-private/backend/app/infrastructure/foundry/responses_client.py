...
class ResponsesWorkflowClient:
    """Invokes the canonical hosted workflow through its private Responses endpoint."""
    ...
    def from_environment(cls) -> ResponsesWorkflowClient:
        ...
        if not endpoint:
            raise RuntimeError(
                "FOUNDRY_RESPONSES_ENDPOINT is required for the Foundry-private Responses wrapper."
            )
