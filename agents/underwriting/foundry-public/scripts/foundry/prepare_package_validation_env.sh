...
foundry_project="underwriting"
hosted_agent="underwriting-hosted"
runtime_connection="underwritingruntimesecrets"
...
set_env FOUNDRY_MODEL_DEPLOYMENT_NAME underwriting-gpt-4-1-mini
set_env FOUNDRY_MODEL_FORMAT OpenAI
set_env FOUNDRY_MODEL_NAME gpt-4.1-mini
set_env FOUNDRY_MODEL_VERSION 2025-04-14
set_env FOUNDRY_MODEL_SKU_NAME DataZoneStandard
set_env FOUNDRY_MODEL_CAPACITY 1500
set_env FOUNDRY_EMBEDDINGS_DEPLOYMENT_NAME underwriting-text-embedding-3-small
set_env FOUNDRY_EMBEDDINGS_MODEL_VERSION 1
set_env FOUNDRY_EMBEDDINGS_MODEL_CAPACITY 120
set_env FOUNDRY_EVAL_MODEL underwriting-gpt-4-1-mini-evaluation
...
set_env POSTGRES_DATABASE underwriting
set_env POSTGRES_RUNTIME_USERNAME underwriting_runtime
...
set_env BACKEND_IMAGE_REPOSITORY underwriting-public-backend
set_env FRONTEND_IMAGE_REPOSITORY underwriting-public-frontend
...
set_env AZURE_OPENAI_ENDPOINT "https://${foundry_account}.cognitiveservices.azure.com/"
